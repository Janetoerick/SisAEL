...
public class ClienteControllerImpl extends ClienteController{
	...
	public ResponseEntity<Cliente> cadastrar(@RequestBody ClienteRestaurante cliente){
	...
	public ResponseEntity<Cliente> atualizar(@RequestBody ClienteRestaurante cliente){
